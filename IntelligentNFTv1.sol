...
contract IntelligentNFTv1 is IIntelligentNFTv1, AccessExtension {
	...
	/**
	 * @dev Creates/deploys an iNFT instance bound to already deployed AI Pod and ALI token instances
	 *
